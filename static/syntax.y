...
function_definition
	: declaration_specifiers declarator declaration_list compound_statement { printf("function dec\n");}
	| declaration_specifiers declarator compound_statement  { printf("function dec\n");}
	;
